...
export default function TimetablePage() {
  ...
  const [grade, setGrade] = useState(searchParams.get("grade") || "1");
  const [classNm, setClassNm] = useState(searchParams.get("classNm") || "");
  ...
  useEffect(() => {
    ...
    if (!searchParams.get("grade") && savedGrade) {
      setGrade(savedGrade);
    }

    if (!searchParams.get("classNm") && savedClassNm) {
